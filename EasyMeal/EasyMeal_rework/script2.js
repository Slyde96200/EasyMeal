...
function eventListeners() {         /* Button features */
...
function showSearchReaslut(e) {         /* Everything is said in the name of the function  ahah */
    e.preventDefault();
...
class Meals {
    static showReasult(mealsme, cont) {             /* Everything is said in the name of the function  ahah */
...
function showRandomMeal() {     /* repetition */        /* ADDING RANDOM MEAL */
